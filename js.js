...
dogs.forEach(function(dog) {
  //Задали новое свойство для каждого массива
...
console.log(`Собака марины ест слишком ${dogMarina.curFood > dogMarina.recommendedFood ? "Много" : "Мало"}`);
...
// В консоль выведится false так как нет собак которые едят грам в грам относительно рекомендуемой порции
